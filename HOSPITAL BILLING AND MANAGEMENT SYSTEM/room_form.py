...
class Room:
    ...
    def __init__(self,master):
        ...
        #===============TITLE==========
        self.lblTitle = Label(self.frame,text = "ROOM ALLOCATION FORM", font="Helvetica 20 bold",bg="LightSalmon")
        ...
        self.room_no1=Label(self.LoginFrame,text="ROOM NUMBER ",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblrate=Label(self.LoginFrame,text="ROOM CHARGES",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblda=Label(self.LoginFrame,text="DATE ADMITTED",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lbldd=Label(self.LoginFrame,text="DATE DISCHARGED",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.button2 = Button(self.LoginFrame2, text="SUBMIT",width =10,font="Helvetica 14 bold",bg="LightSalmon",command=self.INSERT_ROOM)
        self.button2.grid(row=3,column=1)
        
        self.button3 = Button(self.LoginFrame2, text="UPDATE",width =10,font="Helvetica 14 bold",bg="LightSalmon",command=self.UPDATE_ROOM)
        self.button3.grid(row=3,column=2)
        
        self.button5 = Button(self.LoginFrame2, text="ROOM DETAILS",width =15,font="Helvetica 14 bold",bg="LightSalmon",command=self.SEARCH_ROOM)
...
class S_Room:
    def __init__(self,master):    
        ...
        self.frame.pack()
        self.Pr_id=IntVar()
        self.lblTitle = Label(self.frame,text = "SEARCH PATIENT DETAILS", font="Helvetica 20 bold",bg="LightSalmon")
        ...
        self.SearchB = Button(self.LoginFrame2, text="SEARCH",width =10,font="Helvetica 14 bold",bg="LightSalmon",command = self.ROOM_DISPLAY)
    ...
    def ROOM_DISPLAY(self):
        ...
        if (len(p)==0):
            ...
            for i in t:
                ...
                self.l3 = Label(self.LoginFrame,text="ROOM NO",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                ...
                self.l4 = Label(self.LoginFrame,text="ROOM TYPE",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
