...
class Patient:
    def __init__(self,master):
        ...
        self.master.config(bg="LightSalmon")
        self.frame = Frame(self.master,bg="LightSalmon")
        self.frame.pack()
        ...
        #===============TITLE==========
        self.lblTitle = Label(self.frame,text = "PATIENT REGISTRATION FORM", font="Helvetica 20 bold",bg="LightSalmon")
        self.lblTitle.grid(row =0 ,column = 0,columnspan=2,pady=50)
        #==============FRAME==========
        self.LoginFrame = Frame(self.frame,width=400,height=80,relief="ridge",bg="LightSalmon",bd=20)
        self.LoginFrame.grid(row=1,column=0)
        
        self.LoginFrame2 = Frame(self.frame,width=400,height=80,relief="ridge",bg="LightSalmon",bd=20)
        self.LoginFrame2.grid(row=2,column=0)
        #===========LABELS=============          
        self.lblpatid = Label(self.LoginFrame,text="PATIENT ID",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblPatname = Label(self.LoginFrame,text="PATIENT NAME",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblsex = Label(self.LoginFrame,text="SEX",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblDOB = Label(self.LoginFrame,text="DOB (YYYY-MM-DD)",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblbgrp = Label(self.LoginFrame,text="BLOOD GROUP",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblCon = Label(self.LoginFrame,text="CONTACT NUMBER",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblAlt = Label(self.LoginFrame,text="ALTERNATE CONTACT",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lbleid = Label(self.LoginFrame,text="EMAIL",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lbldoc = Label(self.LoginFrame,text="CONSULTING TEAM / DOCTOR",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lbladd = Label(self.LoginFrame,text="ADDRESS",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.button2 = Button(self.LoginFrame2, text="SUBMIT",width =10,font="Helvetica 14 bold",bg="LightSalmon",command = self.INSERT_PAT)
        self.button2.grid(row=3,column=1)
        
        self.button3 = Button(self.LoginFrame2, text="UPDATE",width =10,font="Helvetica 14 bold",bg="LightSalmon",command= self.UPDATE_PAT)
        self.button3.grid(row=3,column=2)
        
        self.button4 = Button(self.LoginFrame2, text="DELETE",width =10,font="Helvetica 14 bold",bg="LightSalmon",command= self.D_DISPLAY)
        self.button4.grid(row=3,column=3)
        
        self.button5 = Button(self.LoginFrame2, text="SEARCH",width =10,font="Helvetica 14 bold",bg="LightSalmon",command= self.S_DISPLAY)
        self.button5.grid(row=3,column=4)
        
        self.button6 = Button(self.LoginFrame2, text="EXIT",width =10,font="Helvetica 14 bold",bg="LightSalmon",command = self.Exit)
...
class DMenu:
    def __init__(self,master):    
        ...
        self.frame.pack()
        self.del_pid=IntVar()
        self.lblTitle = Label(self.frame,text = "DELETE WINDOW", font="Helvetica 20 bold",bg="LightSalmon")
        self.lblTitle.grid(row =0 ,column = 0,columnspan=2,pady=50)
        #==============FRAME==========
        self.LoginFrame = Frame(self.frame,width=400,height=80,relief="ridge",bg="LightSalmon",bd=20)
        self.LoginFrame.grid(row=1,column=0)
        ...
        self.LoginFrame2.grid(row=2,column=0)
        #===========LABELS=============          
        self.lblpatid = Label(self.LoginFrame,text="ENTER PATIENT ID TO DELETE",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        self.lblpatid.grid(row=0,column=0)
        self.lblpatid= Entry(self.LoginFrame,font="Helvetica 14 bold",bd=2,textvariable= self.del_pid)
        self.lblpatid.grid(row=0,column=1)

        self.DeleteB = Button(self.LoginFrame2, text="DELETE",width =10,font="Helvetica 14 bold",bg="LightSalmon",command = self.DELETE_PAT)
...
class SMenu:
    def __init__(self,master):    
        ...
        self.frame.pack()
        self.s_pid=IntVar()
        self.lblTitle = Label(self.frame,text = "SEARCH WINDOW", font="Helvetica 20 bold",bg="LightSalmon")
        ...
        #===========LABELS=============          
        self.lblpatid = Label(self.LoginFrame,text="ENTER PATIENT ID TO SEARCH",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        self.lblpatid.grid(row=0,column=0)
        self.lblpatid= Entry(self.LoginFrame,font="Helvetica 14 bold",bd=2,textvariable= self.s_pid)
        self.lblpatid.grid(row=0,column=1)

        self.SearchB = Button(self.LoginFrame2, text="SEARCH",width =10,font="Helvetica 14 bold",bg="LightSalmon",command = self.SEARCH_PAT)
    ...
    def SEARCH_PAT(self):
        ...
        if (len(p)==0):
            ...
            for i in t:
                        self.l1 = Label(self.LoginFrame,text="PATIENT ID",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l1.grid(row=1,column=0)
                        self.dis1= Label(self.LoginFrame,font="Helvetica 14 bold",bd=2,bg="LightSalmon",text=i[0])
                        self.dis1.grid(row=1,column=1)
                        
                        self.l2 = Label(self.LoginFrame,text="PATIENT NAME",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l2.grid(row=2,column=0)
                        self.dis2=Label(self.LoginFrame,font="Helvetica 14 bold",bd=2,bg="LightSalmon",text=i[1])
                        self.dis2.grid(row=2,column=1)

                        self.l3 = Label(self.LoginFrame,text="SEX",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l3.grid(row=3,column=0)
                        self.dis3  = Label(self.LoginFrame,font="Helvetica 14 bold",bg="LightSalmon",bd=2,text=i[2])
                        self.dis3.grid(row=3,column=1)

                        self.l4 = Label(self.LoginFrame,text="DOB (YYYY-MM-DD)",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l4.grid(row=4,column=0)
                        self.dis4= Label(self.LoginFrame,font="Helvetica 14 bold",bg="LightSalmon",bd=2,text=i[3])
                        self.dis4.grid(row=4,column=1)
                        
                        self.l5 = Label(self.LoginFrame,text="BLOOD GROUP",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l5.grid(row=5,column=0)
                        self.dis5 = Label(self.LoginFrame,font="Helvetica 14 bold",bg="LightSalmon",bd=2,text=i[4])
                        self.dis5.grid(row=5,column=1)
                        
                        self.l6 = Label(self.LoginFrame,text="ADDRESS",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l6.grid(row=1,column=2)
                        self.dis6  = Label(self.LoginFrame,font="Helvetica 14 bold",bg="LightSalmon",bd=2,text=i[5])
                        self.dis6.grid(row=1,column=3)
                        
                        self.l7 = Label(self.LoginFrame,text="CONSULTING TEAM / DOCTOR",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l7.grid(row=2,column=2)
                        self.dis7  = Label(self.LoginFrame,font="Helvetica 14 bold",bd=2,bg="LightSalmon",text=i[6])
                        self.dis7.grid(row=2,column=3)
                        
                        self.l8 = Label(self.LoginFrame,text="EMAIL",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l8.grid(row=3,column=2)
                        self.dis8  = Label(self.LoginFrame,font="Helvetica 14 bold",bd=2,bg="LightSalmon",text=i[7])
                        self.dis8.grid(row=3,column=3)

                        self.l9 = Label(self.LoginFrame,text="CONTACT NUMBER",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l9.grid(row=4,column=2)
                        self.dis9  = Label(self.LoginFrame,font="Helvetica 14 bold",bd=2,bg="LightSalmon",text=i[8])
                        self.dis9.grid(row=4,column=3)

                        self.l10 = Label(self.LoginFrame,text="ALTERNATE CONTACT",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
                        self.l10.grid(row=5,column=2)
                        self.dis10 = Label(self.LoginFrame,font="Helvetica 14 bold",bd=2,bg="LightSalmon",text=i[9])
