...
class Employee:
    def __init__(self,master):
        ...
        #===============TITLE==========
        self.lblTitle = Label(self.frame,text = "EMPLOYEE REGISTRATION FORM", font="Helvetica 20 bold",bg="LightSalmon")
        ...
        #===========LABELS=============          
        self.lblempid = Label(self.LoginFrame,text="EMPLOYEE ID",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblempname = Label(self.LoginFrame,text="EMPLOYEE NAME",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblage = Label(self.LoginFrame,text="AGE",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.etype1=Label(self.LoginFrame,text="EMPLOYEE DESIGNATION [DOCTOR,NURSE,RECEPTIONIST] ",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblCon = Label(self.LoginFrame,text="SALARY",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lblAlt = Label(self.LoginFrame,text="EXPERIENCE",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.lbleid = Label(self.LoginFrame,text="CONTACT NUMBER",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.button2 = Button(self.LoginFrame2, text="SAVE",width =10,font="Helvetica 14 bold",bg="LightSalmon",command = self.INSERT_EMP)
        self.button2.grid(row=3,column=1)
        
        self.button3 = Button(self.LoginFrame2, text="DELETE",width =10,font="Helvetica 14 bold",bg="LightSalmon",command= self.DE_DISPLAY)
...
class D_EMP:
    def __init__(self,master):    
        ...
        self.lblTitle = Label(self.frame,text = "DELETE EMPLOYEE WINDOW", font="Helvetica 20 bold",bg="LightSalmon")
        self.lblTitle.grid(row =0 ,column = 0,columnspan=2,pady=50)
        #==============FRAME==========
        self.LoginFrame = Frame(self.frame,width=400,height=80,relief="ridge",bg="LightSalmon",bd=20)
        self.LoginFrame.grid(row=1,column=0)
        ...
        self.LoginFrame2.grid(row=2,column=0)
        #===========LABELS=============          
        self.lblpatid = Label(self.LoginFrame,text="ENTER EMPLOYEE ID TO DELETE",font="Helvetica 14 bold",bg="LightSalmon",bd=22)
        ...
        self.DeleteB = Button(self.LoginFrame2, text="DELETE",width =10,font="Helvetica 14 bold",bg="LightSalmon",command = self.DELETE_EMP)
